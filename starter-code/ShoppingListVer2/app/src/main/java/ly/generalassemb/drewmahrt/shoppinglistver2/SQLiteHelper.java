...
public class SQLiteHelper {
    ...
    public class SQLiteOpenHelper extends android.database.sqlite.SQLiteOpenHelper {
        ...
        public List<ItemsObject> getAllAsList(){

            SQLiteDatabase db = getReadableDatabase();

            Cursor cursor = db.query(TABLE_NAME, new String[]{COL_ITEM_NAME, COL_DESCRIPTION, COL_PRICE, COL_TYPE}, null, null, null, null, null);
